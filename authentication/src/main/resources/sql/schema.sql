...
INSERT INTO `tb_console_user` ( `id`, `creation_time`, `email`, `password`, `status`, `username`, `real_name`, `gender`, `groups_info`, `resource_map`, `remark` ) VALUES ( 1, '2021-08-18 09:40:46.953', 'admin@domian.com', '$2a$10$U2787VFuFP9NMyxwdsP1bOmtvofTgwU5nLcdV7Gj3ZyhdiZO.T8mG', 1, 'admin', '超级管理员', 10, '[{\"id\": 1, \"name\": \"超级管理员\", \"authority\": \"ADMIN\"}]', '{}', NULL );