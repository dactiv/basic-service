...
(
    ...
    `last_update_time` datetime(3) NOT NULL COMMENT '最后修改时间',
...
INSERT INTO `tb_console_user`(`id`, `email`, `password`, `status`, `username`, `real_name`, `creation_time`,
                              `last_update_time`, `remark`)
VALUES (1, 'admin@domian.com', '$2a$10$U2787VFuFP9NMyxwdsP1bOmtvofTgwU5nLcdV7Gj3ZyhdiZO.T8mG', 1, 'admin', '超级管理员',
        '2020-03-01 21:57:46', '2020-03-01 21:57:46', NULL);

INSERT INTO `tb_member_user`(`creation_time`, `last_update_time`, `username`, `password`, `email`, `phone`, `status`)
VALUES ('2020-04-16 17:21:56', '2020-04-16 17:21:56', 'maurice',
        '$2a$10$U2787VFuFP9NMyxwdsP1bOmtvofTgwU5nLcdV7Gj3ZyhdiZO.T8mG', '', '18776974353', 1);

INSERT INTO `tb_member_user_initialization`(`user_id`, `modify_password`, `modify_username`, `creation_time`,
                                            `last_update_time`, `build_email`)
VALUES (1, 0, 0, '2020-03-01 21:57:46', '2020-03-01 21:57:46', 0);

INSERT INTO `tb_group`(`id`, `name`, `authority`, source, `parent_id`, `status`, `removable`, `modifiable`,
                       `creation_time`, `last_update_time`, `remark`)
VALUES (1, '超级管理员', 'ADMIN', 'Console', NULL, 0, 0, 1, '2020-03-01 21:56:25', '2020-03-01 21:56:25', NULL);
INSERT INTO `tb_group`(`id`, `name`, `authority`, source, `parent_id`, `status`, `removable`, `modifiable`,
                       `creation_time`, `last_update_time`, `remark`)
VALUES (2, '普通用户', 'ORDINARY', 'UserCenter', NULL, 0, 0, 1, '2020-03-01 21:56:25', '2020-03-01 21:56:25', NULL);

INSERT INTO `tb_group_console_user`(`group_id`, `user_id`)
VALUES (1, 1);

INSERT INTO `tb_group_member_user`(`group_id`, `user_id`)
VALUES (2, 1);
